...
public class ClientesDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ClientesGlobalFeatureConfigurator.Configure();
        ClientesModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<ClientesDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<ClientesResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/Clientes");

            options.DefaultResourceType = typeof(ClientesResource);
        ...
        {
            options.MapCodeNamespace("Clientes", typeof(ClientesResource));
        });
    }
}
